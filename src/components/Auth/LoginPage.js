...
function LoginPage({ username, password, submit }) {
  return (
    <div className="App">
      <Paper sx={{
      ...
      >
        ...
        <form className="form">
          ...
          <TextField type="password" id="password" label="password" variant="outlined" sx={{ marginBottom: 2 }} onChange={(e) => password(e.target.value)} />
