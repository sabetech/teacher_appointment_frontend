        ...
        <div className="App">
          ...
          <h2>Add Teacher</h2>
            <form className="form">
                ...
                <TextField type="text" id="bio" label="Bio" variant="outlined" sx={{marginBottom: 2}} onChange={ (e)=> handleBio(e.target.value)} />
                <TextField type="text" id="experience" label="Work Experience" variant="outlined" sx={{marginBottom: 2}} onChange={ (e)=> handleXp(e.target.value)} />
                <Button variant="contained" component="label" sx={{marginBottom: 2}}>
                    Upload
                    <input hidden accept="image/*" type="file" onChange={handlePhoto}/> Image {teacherphoto?.name}
                </Button>
